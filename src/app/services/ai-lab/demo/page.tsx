        ...
        <TabsContent value="events" className="mt-6 animate-tab-fade-in">
          ...
          <div className="space-y-4">
            {filteredEvents.map((event) => (
              <Card key={event.id} className="transition-[box-shadow,transform] duration-300 hover:shadow-lg hover:-translate-y-0.5">
                <CardContent>
        ...
        <TabsContent value="projects" className="mt-6 animate-tab-fade-in">
          <div className="space-y-4">
            {PROJECTS.map((project) => (
              <Card key={project.id} className="transition-[box-shadow,transform] duration-300 hover:shadow-lg hover:-translate-y-0.5">
                <CardContent>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full rounded-md border bg-background px-3 py-2 text-sm outline-none focus:ring-[3px] focus:ring-primary/20 resize-none"
                  />
                </div>
