        ...
        <TabsContent value="systems" className="mt-6 animate-tab-fade-in">
          <div className="grid gap-4 sm:grid-cols-2">
            {SYSTEMS.map((sys) => (
              <Card
                key={sys.id}
                className={`cursor-pointer transition-[box-shadow,transform] duration-300 hover:shadow-md hover:-translate-y-0.5 ${
              ...
              return (
                <div key={priority}>
                  ...
                  <div className="space-y-3">
                    {items.map((item) => (
                      <Card key={item.id} className="transition-[box-shadow,transform] duration-300 hover:shadow-md hover:-translate-y-0.5">
                        <CardContent>
