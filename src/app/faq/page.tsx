            ...
            <div key={section.category} className="mb-10">
              ...
              <div className="space-y-3">
                {section.items.map((faq) => (
                  <details
                    key={faq.q}
                    className="group rounded-lg border border-border bg-card transition-[box-shadow,border-color,background-color] duration-200 hover:shadow-md open:shadow-md open:border-l-2 open:border-l-primary open:bg-muted/30 dark:open:bg-muted/40"
                  >
